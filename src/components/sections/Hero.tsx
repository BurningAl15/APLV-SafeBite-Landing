...
export default function Hero() {
    ...
    return (
        <section id="hero" aria-label={t('headline')} className="w-full max-w-5xl mx-auto pt-20 pb-16 px-8 flex flex-col items-center text-center">
            <div className="flex items-center gap-3 mb-10 transition-opacity hover:opacity-80" aria-hidden="true">
                <Image
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center justify-center w-full mb-20" role="group" aria-label="Download SafeBite">
                <a
                    href="https://apps.apple.com/app/safebite/id123456789"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Download SafeBite on the App Store"
                ...
                >
                    <svg aria-hidden="true" className="w-8 h-8" viewBox="0 0 384 512" fill="currentColor">
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Get SafeBite on Google Play"
                ...
                >
                    <svg aria-hidden="true" className="w-8 h-8 text-primary" viewBox="0 0 512 512" fill="currentColor">
            ...
            <div className="relative w-full max-w-4xl mx-auto px-4">
                <div className="absolute inset-0 bg-primary/5 blur-[120px] rounded-full scale-75 -z-10" aria-hidden="true" />
                <Image
                    src="/safebite_hero_mockup.png"
                    alt="SafeBite app screenshot showing a food label scan with a safety result"
                    width={1200}
                    height={800}
