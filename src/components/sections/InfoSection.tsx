        ...
        <section className="w-full max-w-3xl mx-auto flex flex-col items-center sm:items-start pb-16 px-8">
            ...
            <div className="w-full flex flex-col gap-4">
                {quickGuide.map((item, index) => (
                    <div key={index} className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden text-left">
                        <button
                        ...
                        >
                            ...
                            <div className="text-gray-400">
                                <svg
                                    className={`w-5 h-5 transition-transform duration-200 ${expandedSection === item.id ? 'rotate-180' : ''}`}
